...
@section('main-content')
  <div class="bg-light py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12 mb-0"><a href="{{ route('homeView') }}">Home</a> <span class="mx-2 mb-0">/</span> <a
  ...
  <div class="site-section">
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-12">
          <div class="rounded border p-4" role="alert">
          ...
          <div class="row mb-5">
            <div class="col-md-12">
              ...
              <div class="p-lg-5 border p-3">
                ...
                <label for="c_code" class="mb-3 text-black">Enter your coupon code if you have one</label>
          ...
          <div class="row mb-5">
            <div class="col-md-12">
              ...
              <div class="p-lg-5 border p-3">
                ...
                <div class="form-group">
                  <button class="btn btn-primary btn-lg btn-block py-3" onclick="window.location='thankyou.html'">Place
                    Order</button>
                </div>
